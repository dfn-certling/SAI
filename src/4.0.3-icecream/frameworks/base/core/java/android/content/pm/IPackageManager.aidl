...
interface IPackageManager {
    ...
    /**
     * timo: install a package _after_ the SKIMS server checked the package
     * OR the user says 'yes'
     *
     */
    void installPackageAfterSaiCheck(in Uri packageURI);
     
     /**
     * timo: abort the installation of a package _after_ the SKIMS server checked the package
     * 
     */
    void abortInstallPackageAfterSaiCheck(in Uri packageURI);
